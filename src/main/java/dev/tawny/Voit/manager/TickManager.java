...
public final class TickManager implements Runnable {
    ...
    public void start() {
        ...
        Bukkit.getServer().getScheduler().scheduleSyncRepeatingTask(Voit.INSTANCE.getPlugin(),new Runnable() {
            @Override
            public void run() {
        ...
        Bukkit.getScheduler().scheduleSyncRepeatingTask(Voit.INSTANCE.getPlugin(), new Runnable() {
            @Override
            public void run() {
        ...
        task = Bukkit.getScheduler().runTaskTimer(Voit.INSTANCE.getPlugin(), this, 0L, 1L);
