...
public final class ActionProcessor {
    ...
    public void handleBlockDig(final WrappedPacketInBlockDig wrapper) {
        ...
        switch (wrapper.getDigType()) {
            case START_DESTROY_BLOCK:
                digging = true;
                lastDiggingTick = Voit.INSTANCE.getTickManager().getTicks();
                break;
    ...
    public void handleArmAnimation() {
        if (digging) lastDiggingTick = Voit.INSTANCE.getTickManager().getTicks();
    }
    ...
    public void handleFlying() {
        ...
        if (digging) lastDiggingTick = Voit.INSTANCE.getTickManager().getTicks();
        if (placing) lastPlaceTick = Voit.INSTANCE.getTickManager().getTicks();
        if (digging) lastBreakTick = Voit.INSTANCE.getTickManager().getTicks();
        if (bukkitPlacing) lastBukkitPlaceTick = Voit.INSTANCE.getTickManager().getTicks();
        if (dropping) lastDropTick = Voit.INSTANCE.getTickManager().getTicks();
