package dev.tawny.Voit.data;

import dev.tawny.Voit.Voit;
import dev.tawny.Voit.check.Check;
import dev.tawny.Voit.config.Config;
import dev.tawny.Voit.data.processor.*;
import dev.tawny.Voit.exempt.ExemptProcessor;
...
import dev.tawny.Voit.util.type.ConcurrentEvictingList;
import dev.tawny.Voit.util.type.EntityHelper;
...
public final class PlayerData {
    ...
    public void teleport(Player player, Location location) {
        Bukkit.getScheduler().runTask(Voit.INSTANCE.getPlugin(), () -> player.teleport(location));
    }
