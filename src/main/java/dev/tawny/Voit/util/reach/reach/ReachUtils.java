package dev.tawny.Voit.util.reach.reach;
...
public class ReachUtils {
    ...
    public static Vector getLook(float xRot, float yRot) {
        float f = VanillaMath.cos(-xRot * 0.017453292F - (float) Math.PI);
        float f1 = VanillaMath.sin(-xRot * 0.017453292F - (float) Math.PI);
        float f2 = -VanillaMath.cos(-yRot * 0.017453292F);
        float f3 = VanillaMath.sin(-yRot * 0.017453292F);
