...
public final class LogUtil {
    ...
    public static class TextFile {
        ...
        public TextFile(final String name, final String path) {
            Voit.INSTANCE.getExecutorService().execute(() -> {
                this.file = new File(Voit.INSTANCE.getPlugin().getDataFolder() + path);
                this.file.mkdirs();
                this.file = new File(Voit.INSTANCE.getPlugin().getDataFolder() + path, name + ".txt");
                try {
