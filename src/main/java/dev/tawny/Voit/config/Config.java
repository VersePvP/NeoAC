package dev.tawny.Voit.config;

import dev.tawny.Voit.Voit;
import dev.tawny.Voit.check.api.CheckInfo;
import dev.tawny.Voit.data.processor.GhostBlockProcessor;
...
public final class Config {
    ...
    private boolean getBoolean(final String string) {
        return Voit.INSTANCE.getPlugin().getConfig().getBoolean(string);
    }

    private boolean getBooleanChecks(final String string) {
        return Voit.INSTANCE.getYaml().getBoolean(string);
    }

    public String getString(final String string) {
        return Voit.INSTANCE.getPlugin().getConfig().getString(string);
    }

    public String getStringChecks(final String string) {
        return Voit.INSTANCE.getYaml().getString(string);
    }

    private int getInteger(final String string) {
        return Voit.INSTANCE.getPlugin().getConfig().getInt(string);
    }

    private int getIntegerChecks(final String string) {
        return Voit.INSTANCE.getYaml().getInt(string);
    }

    private double getDouble(final String string) {
        return Voit.INSTANCE.getPlugin().getConfig().getDouble(string);
    }

    private double getDoubleChecks(final String string) {
        return Voit.INSTANCE.getYaml().getDouble(string);
    }

    private long getLong(final String string) {
        return Voit.INSTANCE.getPlugin().getConfig().getLong(string);
    }

    private long getLongChecks(final String string) {
        return Voit.INSTANCE.getYaml().getLong(string);
    }

    private List<String> getList(final String string) {
        return Voit.INSTANCE.getPlugin().getConfig().getStringList(string);
    }

    private List<String> getListChecks(final String string) {
        return Voit.INSTANCE.getYaml().getStringList(string);
    }
}
